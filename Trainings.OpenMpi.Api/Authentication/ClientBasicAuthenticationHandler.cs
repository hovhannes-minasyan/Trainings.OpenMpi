...
namespace Trainings.OpenMpi.Api.Authentication
{
    public class ClientBasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public ClientBasicAuthenticationHandler(
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var list = Request.Headers.Select(a => a.Key).ToArray();
            ...
            try
            {
                ...
                user = await dbcontext.Users.FirstOrDefaultAsync(a => a.Username == username && a.Password == password);
            }
            catch
            {
